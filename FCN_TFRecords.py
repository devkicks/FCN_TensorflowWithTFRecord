...
## REMOVED all download and extraction code - not required - only need tfrecords
...
# Inference model function - builds the computation graph for our model
# uses VGG layers and adds new layers at the end
...
# train function defines the optimizer for training the model
def train(loss_val, var_list):
    optimizer = tf.train.AdamOptimizer(inArgs.learning_rate)
