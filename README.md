# FCN.tensorflow
NOTE: This is a reupload of the original repository as the size of the original repo was too big for fork. This is an attempt to incorporate TFRecords based data into the original code. 
